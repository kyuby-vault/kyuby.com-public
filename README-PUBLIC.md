...
## Copyright and licensing transition

Effective from the first public commit containing this notice (2026-09-25), new original material first published by the project from that commit onward is not offered under MIT or another project-wide license, unless expressly stated otherwise. All rights in that new material are reserved, subject to applicable law and rights granted under [GitHub's Terms of Service](https://docs.github.com/en/site-policy/github-terms/github-terms-of-service), including viewing and forking public repositories. Public availability alone grants no additional permission to use, redistribute, or modify that new material.

Material previously released under MIT remains available under those MIT grants, including when retained in later versions. This transition does not revoke or restrict those existing permissions. The [historical MIT license and copyright notice](https://github.com/kyuby-vault/kyuby.com-public/blob/891f1435d74fd75be767bf1d163fe357123d8d2f/LICENSE) remain available; copies or substantial portions distributed under MIT must retain its required copyright and permission notices. Earlier MIT grants do not automatically extend to new material covered by this transition.

Third-party code, dependencies, and assets remain subject to their own licenses and required notices. This notice does not change third-party rights or relicense contributions the project does not own. Contact the maintainers for permission beyond the rights described above.
